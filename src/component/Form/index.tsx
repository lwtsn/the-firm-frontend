...
export const FormInputGroup: React.FC = (props: any) => (
    <InputGroup {...props.input} readOnly={props.readOnly} disabled={props.disabled} />
);

export const FormTextarea: React.FC = (props: any) => (
    <TextArea
        {...props.input}
...
export const FormSelect = (props: any) => (
    <HTMLSelect {...props.input} disabled={props.disabled} fill>
        {props.children}
    </HTMLSelect>
);
