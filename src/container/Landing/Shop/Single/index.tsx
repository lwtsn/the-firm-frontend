...
import { getItemByAddress, getShopContract, getTrainingContract } from '@app/web3/contracts';
...
export const Single = () => {
    ...
    const [item, setItem] = useState<SingleItem>(undefined);
        ...
        <Wrapper>
            <div className={'row mb-1'}>
                ...
                <div className={'col-xs-9'}>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pulvinar quam sem, eu auctor eros
                        tempor vitae. Curabitur in massa arcu. Fusce euismod erat tellus, et rutrum justo porttitor
                        eget. Curabitur tempus sagittis accumsan. Morbi a massa consectetur, congue lectus non,
                        imperdiet quam. Curabitur arcu est, tempor at vestibulum eget, porta sit amet nisi. Vestibulum
                        lobortis lectus enim, vel maximus ipsum tincidunt non.
                    </p>
